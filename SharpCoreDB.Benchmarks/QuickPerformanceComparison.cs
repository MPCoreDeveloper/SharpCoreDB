...
public static class QuickPerformanceComparison
{
    public static void Run()
    {
        ...
        Console.WriteLine($"? OLD Dictionary Lookup:  {oldLookupTime:F4}ms ({oldLookupTime * 1000:F1}�s)");
        Console.WriteLine($"? NEW Generic Lookup:     {newLookupTime:F4}ms ({newLookupTime * 1000:F1}�s)");

...
**Status:** Active documentation set (`2.0.0.3`)
...
- `2.0.0.3_WHAT_CHANGED.md` — **what's new in 2.0.0.3** (maintenance: cognitive-complexity
  refactors + NuGet dependency updates, no API/format changes)

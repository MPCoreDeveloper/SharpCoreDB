...
- `docs/proposals/ADR_FLUENTMIGRATOR_PACKAGE_PLACEMENT_v1.9.0.md` — Package-boundary architecture decision for FluentMigrator

---

## Additional Architecture Decision Record

### **[ADR: FluentMigrator Package Placement (v1.9.0)](./ADR_FLUENTMIGRATOR_PACKAGE_PLACEMENT_v1.9.0.md)**

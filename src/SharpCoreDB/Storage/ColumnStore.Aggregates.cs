...
public sealed partial class ColumnStore<T>
{
    ...
    private static int SumInt32ParallelSIMD(int[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain; splitting would duplicate the guarded tail handling
    {
    ...
    private static int MinInt32SIMDDirect(int[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain
    {
    ...
    private static long MinInt64SIMDDirect(long[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain
    {
        if (data.Length == 0) return 0;
    ...
    private static double MinDoubleSIMDDirect(double[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain
    {
        if (data.Length == 0) return 0;
    ...
    private static int MaxInt32SIMDDirect(int[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain
    {
        if (data.Length == 0) return 0;
    ...
    private static long MaxInt64SIMDDirect(long[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain
    {
        if (data.Length == 0) return 0;
    ...
    private static double MaxDoubleSIMDDirect(double[] data) // NOSONAR:S3776 - hardware-intrinsic SIMD kernel with vector-width fallback chain
    {
        if (data.Length == 0) return 0;

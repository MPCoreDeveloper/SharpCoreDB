    ...
    ILogger<TenantProvisioningService> logger) : IAsyncDisposable
{
    ...
    private static string GenerateDatabaseName(string tenantKey)
    {
        ...
        var sanitized = System.Text.RegularExpressions.Regex.Replace(tenantKey, @"[^a-zA-Z0-9_-]", "_", System.Text.RegularExpressions.RegexOptions.None, TimeSpan.FromSeconds(1));

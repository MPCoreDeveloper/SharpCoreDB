...
- Inherits all v1.9.0 engine improvements (Auto-ROWID, GRAPH_RAG, SIMD optimization, Logging.Abstractions 10.0.7).
...
- ✅ Inherits v1.9.0 engine improvements (Auto-ROWID, GRAPH_RAG SQL, SIMD optimization)
